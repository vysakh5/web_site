...
function PureKnob() {
    ...
    this.createKnob = function(width, height) {
        ...
        input.style.color = '#3498DB'; //color
...
function demoKnob() {
    ...
    knob.setProperty('colorFG', '#3498DB');
    ...
    // Add it to the DOM.
    const elem = document.getElementById('knob1');
...
function demoKnob2() {
    ...
    // Add it to the DOM.
    const elem = document.getElementById('knob2');
    elem.appendChild(node);
...
function demoKnob3() {
    ...
    // Add it to the DOM.
    const elem = document.getElementById('knob3');
    elem.appendChild(node);
